...
set_identity("<Your Name> <Your Email>")
...
if __name__ == "__main__":
    ticker_file_path = os.path.expanduser("<where are tickers coming from>")
    ticker_cik_file_path = os.path.expanduser("<where are ticker CIK conversions coming from coming from>")
    output_folder = os.path.expanduser("<What/where do you want output file to be>")
